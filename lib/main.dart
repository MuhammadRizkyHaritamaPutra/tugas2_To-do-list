  ...
  void toggleTask(int index) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: task.isCompleted ? Colors.green : Colors.deepPurpleAccent,
        duration: const Duration(seconds: 1),
        behavior: SnackBarBehavior.floating,
      ),
    );
      ...
      appBar: AppBar(
        title: const Text(
          ...
          style: TextStyle(
            ...
            fontSize: 20,        // opsional: ukuran font
            fontWeight: FontWeight.bold, // opsional: tebal
          ),
        ),
                        ...
                        child: Opacity(
                          ...
                          child: ListTile(
                            ...
                            leading: Container(
                              ...
                              decoration: BoxDecoration(
                                color: task.isCompleted ? Colors.white : Colors.deepPurpleAccent,
